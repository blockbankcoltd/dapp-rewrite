...
import ModalContent from "../components/local/wallet/ModalContent";
    ...
    renderEditable(cellInfo, flag) {
        if (flag === "deposit") {
            return<div><button onClick={(e) => this.deposit(e, cellInfo)} type="button">Deposit</button>
                <button type="button" onClick={(e)=>this.onOpenModal(e)} value="deposit">Deposit_pop</button>
            </div>
        } else {
            return <div><button onClick={(e) => this.withdraw(e, cellInfo)} type="button">Withdraw</button>
                <button type="button" onClick={(e)=>this.onOpenModal(e)} value="withdraw">Withdraw_pop</button>
            </div>
        }
    }
          ...
          <Wallet>
            <section className="main" role="">
              <div id="wallet" className="wallet_wrap">
                  <ModalA open={this.state.open}>
                      {
                          <ModalContent close={this.onCloseModal} type={this.state.type}/>
                      }
                  </ModalA>
                <div className="container">
                  ...
                  <div className="asset_balance">
                      <button onClick={(e)=>this.onOpenModal(e)} type="button" value="gas">Settings Gas Fee</button>
                    <div>
